...
public class PersonFlows {
  ...
  private void changeCurrency(Account account) throws IOException {
    ...
    switch(newCurrency) {
      case "1": changeAccountToCurrency(account, 1);break;
      case "2": changeAccountToCurrency(account, 2);break;
      case "3": changeAccountToCurrency(account, 3);break;
      default: log.warn("Incorrect choice! ");
    }
  }

  private void changeAccountToCurrency(Account account, Integer currencyId) throws IOException {

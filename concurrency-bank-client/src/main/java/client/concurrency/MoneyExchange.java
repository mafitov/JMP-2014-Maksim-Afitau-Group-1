...
public class MoneyExchange implements Runnable {

  private static final Logger log = Logger.getLogger(MoneyExchange.class);
  ...
  public MoneyExchange(List<Account> accounts) {
  ...
  public void run() {
    ...
    for(int i = 0;  i  < NUMBER_OF_OPERATIONS; ++i) {
      ...
      Boolean selectedAccountsCorrect = accountTo != null && accountFrom != null && accountIdFrom != accountIdTo;
